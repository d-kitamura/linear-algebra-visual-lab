...
- [`docs/DIAGONALIZATION_API_CONTRACT.md`](./docs/DIAGONALIZATION_API_CONTRACT.md): 13.1の承認済み契約と13.2の数学API実装記録（D-117確認待ち）
