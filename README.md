...
- [`docs/DIAGONALIZATION_API_CONTRACT.md`](./docs/DIAGONALIZATION_API_CONTRACT.md): 13.1の承認済み契約、13.2数学APIと13.3〜13.6画面・共有の実装記録（D-120承認済み、D-122確認待ち）
