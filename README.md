...
- [`docs/DIAGONALIZATION_API_CONTRACT.md`](./docs/DIAGONALIZATION_API_CONTRACT.md): 13.1の承認済み契約、13.2数学APIと13.3〜13.5画面の実装記録（D-119承認済み、D-120確認待ち）
