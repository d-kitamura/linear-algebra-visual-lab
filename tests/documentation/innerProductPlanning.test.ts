...
describe('フェーズ14詳細設計（D-128・D-129承認・14.5数0〜3D接続）', () => {
  it('14.5の確認待ちと未着手の14.6〜14.9を区別する', () => {
    ...
    expect(dimensionsUnit.match(/- \[x\]/g)).toHaveLength(2);
    expect(dimensionsUnit).toContain('- [ ] **確認ゲート:** D-130');
    expect(phase.split('### 14.6 ')[1]).not.toContain('- [x]');
