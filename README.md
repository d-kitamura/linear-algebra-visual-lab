...
次の単元は[内積・正規直交基底Labの詳細設計案](docs/INNER_PRODUCT_LAB_DESIGN.md)と[フェーズ14ロードマップ](ROADMAP.md)を参照してください（D-125承認済み、[14.1具体契約](docs/INNER_PRODUCT_API_CONTRACT.md)・D-126承認済み、14.2数学API・D-127確認待ち、画面は未着手）。
