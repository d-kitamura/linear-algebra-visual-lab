...
2026-09-05に10.5とD-086の利用者確認が完了しました。引継ぎ棚卸しで見つかった基底判定の対象空間と表示の不一致はD-087へ記録し、10.6前の補修候補としています。現在地と確認範囲は [`docs/INVENTORY_2026-09-05.md`](./docs/INVENTORY_2026-09-05.md) を参照してください。
