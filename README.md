...
フェーズ 3「2D 教材版の完成」まで実装・利用者確認・統合棚卸しが完了しています。0〜8本のベクトル編集、入力案内、アクセシビリティ、モバイル操作、5つの授業シナリオ、灰色系の生成する空間の表示を含む2D教材版を、公開環境で利用できます。公開版は [Linear Algebra Visual Lab](https://d-kitamura.github.io/linear-algebra-visual-lab/) です。次はフェーズ 4「3D 教材版」の作業単位を検討します。
