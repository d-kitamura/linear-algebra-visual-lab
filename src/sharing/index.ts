export {
  ...
  DIAGONALIZATION_SHARE_STATE_VERSION,
  INNER_PRODUCT_SHARE_STATE_VERSION,
  validateInnerProductShareState,
  validateDiagonalizationShareState,
...
export type {
  ...
  DiagonalizationShareState,
  InnerProductShareState,
