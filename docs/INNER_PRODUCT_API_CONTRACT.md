...
2026-09-22更新。**D-125・D-126・D-127は利用者承認済み。14.3・14.4（D-128・D-129）承認済み、14.5・D-130承認済み、14.6・D-131承認済み、14.7共有実装済み・D-132確認待ち。** 共有デコーダーと対象Labの意味検証を接続済み。14.2〜14.7の実装記録は第10〜15節を参照。実画面確認後の見直しを認める。
...
D-127は2026-09-21に承認済み。数2D画面は14.3、GS操作は14.4、数0〜3Dは14.5、多項式1〜3Dは14.6で接続した（第11〜14節）。共有は14.7で接続済み（第15節）。次の14.8は教材資料・既存UI導線の整理を行う。
...
- 次の14.8は教材資料・既存UI導線の整理が中心のため「中」推奨。
