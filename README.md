...
内積Labの18件の本番URL・観察課題・独立期待値は[内積・正規直交基底Labの授業資料](docs/INNER_PRODUCT_TEACHING_GUIDE.md)を参照してください（14.8・D-133確認待ち）。

次の単元は[内積・正規直交基底Labの詳細設計案](docs/INNER_PRODUCT_LAB_DESIGN.md)と[フェーズ14ロードマップ](ROADMAP.md)を参照してください（D-125承認済み、[14.1具体契約](docs/INNER_PRODUCT_API_CONTRACT.md)・D-126承認済み、14.2数学API・D-127承認済み、14.3・14.4（D-128・D-129）承認済み、14.5・D-130承認済み、14.6・D-131承認済み、14.7共有URL・QR実装済み・D-132確認待ち、14.8授業資料・操作導線整備済み・D-133確認待ち）。
