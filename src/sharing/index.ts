export {
  ...
  REPRESENTATION_MATRIX_SHARE_STATE_VERSION,
  EIGENSPACE_SHARE_STATE_VERSION,
  validateEigenspaceShareState,
  validateRepresentationMatrixShareState,
...
export type {
  ...
  ShareStateV4,
  SharedState,
  EigenspaceShareState,
  RepresentationMatrixShareState,
  SharedRepresentationBasisVector,
  BasisDimensionShareState,
  BasisDimensionShareStateV1,
  BasisDimensionShareStateV2,
  BasisRepresentation,
  LinearMapShareState,
  LinearMapShareStateV1,
  LinearMapShareStateV2,
  SharedCameraState,
